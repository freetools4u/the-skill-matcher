...
export default function App() {
  ...
  const handleCandidateSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setNotification(`Application for "${roleName}"${cvText} has been successfully submitted and forwarded to support@zenire.in! Thank you, ${candidateForm.name}. Our candidate operations team will review your credentials and contact you shortly.`);
  ...
  const handleCompanySubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      setIsSubmitting(false);
      setNotification(`Hiring inquiry for "${needs}" talent has been successfully sent to support@zenire.in! Thank you, a client partner will reach out to ${companyForm.contactName} from ${company} at ${email} within 24 hours.`);
  ...
  // Master state for view toggling: 'home' | 'jobs' | 'admin'
  const [currentView, setCurrentView] = useState<"home" | "jobs" | "admin">("home");
  ...
  const services = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1521791136368-1a9b7de71a3a?w=500&auto=format&fit=crop&q=80"
    },
    {
          ...
          <div className="flex items-center gap-2.5 cursor-pointer group" onClick={() => { setCurrentView("home"); window.scrollTo({ top: 0, behavior: "smooth" }); }}>
            <div className="flex items-center justify-center h-10 w-10 shrink-0 transform group-hover:scale-105 transition duration-300">
              <svg className="h-9 w-9" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M25 25H75L35 75H75" stroke="url(#logo-grad-header)" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" />
                <circle cx="25" cy="25" r="7" fill="#059669" />
                <circle cx="75" cy="25" r="7" fill="#2563eb" />
                <circle cx="35" cy="75" r="7" fill="#059669" />
                <circle cx="75" cy="75" r="7" fill="#2563eb" />
              </svg>
            </div>
            <div className="flex flex-col">
              <span className="font-display font-black text-lg tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600 group-hover:from-emerald-700 group-hover:to-blue-700 transition">Zenire.in</span>
              <span className="text-[10px] uppercase tracking-wider text-slate-500 font-bold -mt-1 font-display">GenZ Hiring Platform</span>
            </div>
          </div>
                ...
                <div className="lg:col-span-7 text-left space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-50 border border-slate-100 rounded-2xl p-4 max-w-md shadow-sm">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-slate-600">
                      ...
                      <span className="text-slate-400 font-medium">(3,400+ reviews)</span>
                    </div>
                  </div>
                      ...
                      >
                        <div className="relative h-20 w-20 rounded-full bg-white border-2 border-emerald-500 shadow-xl flex items-center justify-center cursor-pointer group-hover:scale-110 transition duration-500">
                          ...
                          <svg className="h-14 w-14" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                              <linearGradient id="logo-grad-hub" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="#059669" />
                                <stop offset="100%" stopColor="#2563eb" />
                              </linearGradient>
                            </defs>
                            <path d="M25 25H75L35 75H75" stroke="url(#logo-grad-hub)" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" />
                            <circle cx="25" cy="25" r="7" fill="#059669" />
                            <circle cx="75" cy="25" r="7" fill="#2563eb" />
                            <circle cx="35" cy="75" r="7" fill="#059669" />
                            <circle cx="75" cy="75" r="7" fill="#2563eb" />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="bg-slate-50/60 border border-slate-100 rounded-2xl p-4 flex items-center gap-3 transition hover:bg-slate-50 hover:shadow-sm duration-200">
              ...
              <div className="text-left">
                <span className="block text-xl font-black text-slate-900 leading-none">35,000+</span>
            ...
            <div className="bg-slate-50/60 border border-slate-100 rounded-2xl p-4 flex items-center gap-3 transition hover:bg-slate-50 hover:shadow-sm duration-200">
              ...
              <div className="text-left">
                <span className="block text-xl font-black text-slate-900 leading-none">2,500+</span>
            ...
            <div className="col-span-2 lg:col-span-1 bg-emerald-50/30 border border-emerald-100/40 rounded-2xl p-4 flex items-center gap-3 transition hover:bg-emerald-50/50 hover:shadow-sm duration-200">
              ...
              <div className="text-left">
                <span className="block text-xl font-black text-slate-900 leading-none">10,000+</span>
                ...
                <div className="space-y-8 relative before:absolute before:left-5 before:top-2 before:bottom-2 before:w-[1px] before:bg-slate-200">
                  ...
                  <div className="flex gap-4 items-start relative">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-xs leading-relaxed">
                        We scan our network of 35,000+ professionals, running specialized benchmarks to short-list top candidates.
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2.5">
                <div className="flex items-center justify-center h-8 w-8 shrink-0">
                  <svg className="h-7 w-7" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M25 25H75L35 75H75" stroke="url(#logo-grad-footer)" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" />
                    <circle cx="25" cy="25" r="7" fill="#10b981" />
                    <circle cx="75" cy="25" r="7" fill="#3b82f6" />
                    <circle cx="35" cy="75" r="7" fill="#10b981" />
                    <circle cx="75" cy="75" r="7" fill="#3b82f6" />
                  </svg>
                </div>
                <div className="flex flex-col">
                  <span className="font-display font-black text-base tracking-tight text-white leading-none">Zenire.in</span>
                  <span className="text-[10px] uppercase tracking-wider text-emerald-400 font-bold font-display mt-1">GenZ Hiring Platform</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                <span className="text-xs font-black text-white tracking-tight">4.5/5 on Trustpilot</span>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4 text-[10px] text-slate-500">
              ...
              <span>•</span>
              <span className="hover:text-slate-400 cursor-pointer">Candidate Agreement</span>
            </div>
          </div>
